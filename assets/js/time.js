function clock() {
	...
	document.querySelectorAll(".hours1")[0].innerHTML= zero(hours),
	document.querySelectorAll(".minutes1")[0].innerHTML = zero(minutes),
	document.querySelectorAll(".seconds1")[0].innerHTML = zero(seconds);
